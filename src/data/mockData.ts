...
export const alerts: Alert[] = [
  {
    id: 'a1', busId: 'b5', plateNumber: '京B·33001', routeName: '育才中学-1号线', schoolName: '育才中学',
    type: 'breach', status: 'pending', reason: '', note: '',
    fenceOutTime: fmt(7, 20), duration: '15分钟', handlerName: '', handleTime: '',
    driverPhone: '139****3001', driverName: '郑伟', attendantName: '吴红梅',
  },
  {
    id: 'a2', busId: 'b13', plateNumber: '京C·77001', routeName: '星星幼儿园-B线', schoolName: '星星幼儿园',
    type: 'breach', status: 'pending', reason: '', note: '',
    fenceOutTime: fmt(7, 15), duration: '21分钟', handlerName: '', handleTime: '',
    driverPhone: '137****7001', driverName: '唐明', attendantName: '林翠花',
  },
  {
    id: 'a3', busId: 'b5', plateNumber: '京B·33001', routeName: '育才中学-1号线', schoolName: '育才中学',
    type: 'breach', status: 'processing', reason: '临时绕行', note: '前方路口封闭，绕行至建设路',
    fenceOutTime: fmt(7, 5), duration: '8分钟', handlerName: '李调度', handleTime: fmt(7, 12),
    driverPhone: '139****3001', driverName: '郑伟', attendantName: '吴红梅',
  },
  {
    id: 'a4', busId: 'b3', plateNumber: '京A·22001', routeName: '阳光小学-西线', schoolName: '阳光小学',
    type: 'breach', status: 'completed', reason: '道路施工', note: '西三环辅路施工，经调度确认绕行',
    fenceOutTime: fmt(6, 40), duration: '12分钟', handlerName: '张调度', handleTime: fmt(6, 48),
    driverPhone: '138****2001', driverName: '刘志强', attendantName: '陈美玲',
  },
  {
    id: 'a5', busId: 'b10', plateNumber: '京B·55002', routeName: '育才中学-3号线', schoolName: '育才中学',
    type: 'breach', status: 'completed', reason: '司机误驶', note: '新司机不熟悉路线，已电话纠正',
    fenceOutTime: fmt(7, 0), duration: '5分钟', handlerName: '李调度', handleTime: fmt(7, 4),
    driverPhone: '139****5002', driverName: '罗勇', attendantName: '朱淑芬',
  },
]

export const handleLogs: HandleLog[] = [
  { id: 'h1', alertId: 'a3', type: 'notification', content: '已通知司机郑伟（139****3001）和安全主管王主任', operatorName: '李调度', operateTime: fmt(7, 12), target: '司机+安全主管' },
  { id: 'h2', alertId: 'a3', type: 'call', content: '与司机郑伟通话确认：前方路口封闭，已绕行至建设路，预计5分钟后回到规定路线', operatorName: '李调度', operateTime: fmt(7, 14), target: '郑伟' },
  { id: 'h3', alertId: 'a4', type: 'notification', content: '已通知司机刘志强（138****2001）和安全主管赵主任', operatorName: '张调度', operateTime: fmt(6, 48), target: '司机+安全主管' },
  { id: 'h4', alertId: 'a4', type: 'call', content: '与司机刘志强通话确认：西三环辅路施工绕行，目前已在回程途中', operatorName: '张调度', operateTime: fmt(6, 50), target: '刘志强' },
  { id: 'h5', alertId: 'a4', type: 'note', content: '车辆已于06:52返回围栏范围内，预警关闭', operatorName: '张调度', operateTime: fmt(6, 52) },
  { id: 'h6', alertId: 'a5', type: 'notification', content: '已通知司机罗勇（139****5002）和安全主管陈主任', operatorName: '李调度', operateTime: fmt(7, 4), target: '司机+安全主管' },
  { id: 'h7', alertId: 'a5', type: 'call', content: '与司机罗勇通话确认：新路线不熟悉导致误驶，已纠正方向', operatorName: '李调度', operateTime: fmt(7, 5), target: '罗勇' },
  { id: 'h8', alertId: 'a5', type: 'note', content: '车辆已于07:06返回围栏范围内，预警关闭', operatorName: '李调度', operateTime: fmt(7, 6) },
]
